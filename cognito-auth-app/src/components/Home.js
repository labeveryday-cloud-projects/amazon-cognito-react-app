              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                  ...
                  <ul>
                    ...
                    <li><a href="#" className="text-blue-600 hover:text-blue-800">Change Password</a></li>
                    <li><a href="#" className="text-blue-600 hover:text-blue-800">Manage Notifications</a></li>
                  </ul>
                </div>
              </div>
            </div>
